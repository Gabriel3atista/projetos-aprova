<template>
    <section class="background-certificacoes-ti relative pb-24 h-auto darkBgColor">
        <main class="relative z-20 flex flex-col justify-center items-center w-full h-full container pt-14 lg:flex-row">
            <div class="flex-1 mt-12 flex flex-col justify-center items-center lg:items-start">
                <div
                    ...
                    <h1 class="font-HeadingNow uppercase text-white md:text-8xl">certificações <br>de <span
                            class="mainTextColor">tecnologia</span></h1>
                </div>
