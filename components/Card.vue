  ...
  <div class="modal-cards flex flex-row gap-6 flex-wrap justify-center">
    ...
    >
      <div class="relative flex flex-col items-center content-center">
        <span
          v-if="index == 0"
          class="mainBgColor tag absolute py-1 px-3 -top-12 border-8 rounded-full text-white"
          >Recomendado</span
        >
        <div class="flex flex-col items-center mt-5">
          <h3 class="uppercase font-bold text-white text-center">
            {{ pacote.attributes.descricao }}
          </h3>
          <p class="text-base-white mt-3">
            {{ pacote.attributes.cargo.split("-")[0] }}
          </p>
          <div class="flex flex-col justify-between mt-12">
            ...
            <div class="flex flex-col justify-center items-center mt-12">
              <Button>
                <a class="block py-2 px-4" @click="compraCurso(pacote.id)"
                  >COMPRAR</a
                >
              </Button>
              <a
                ...
                class="text-base-white mt-4 cursor-pointer hover:underline"
                >Saiba mais</a
              >
            </div>
          </div>
